...
(2, 'admin', '', 'ehcp', '81dc9bdb52d04dc20036dbd8313ed055', 'info@ehcp.net', 10000, 10, 100, 10, 10, 10, 'passive', 'this is for supporting ehcp, we will use this when we need hosting, Please keep this to support ehcp');
